...
phaxio_user3 = Email.create!(email: 'ceo@phaxio.com', caller_id_number: founder_num.fax_number, client_id: phaxio.id)
phaxio_user4 = Email.create!(email: 'cto@phaxio.com', caller_id_number: founder_num.fax_number, client_id: phaxio.id)
phaxio_user1 = Email.create!(email: 'marketing1@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user2 = Email.create!(email: 'marketing2@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user5 = Email.create!(email: 'developer1@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user6 = Email.create!(email: 'developer2@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user7 = Email.create!(email: 'matt@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)

fake1 = Email.create!(email: 'faker1@aol.com', caller_id_number: fake_num1.fax_number, client_id: fakers.id)
fake2 = Email.create!(email: 'faker2@aol.com', caller_id_number: fake_num1.fax_number, client_id: fakers.id)
fake3 = Email.create!(email: 'faker3@aol.com', caller_id_number: fake_num2.fax_number, client_id: fakers.id)
