admin = User.create!(type: :Admin, email: "mwmayerle@gmail.com", password: 'tomtom')
phaxio_manager = User.create!(type: :ClientManager, email: "manager@phaxio.com", password: 'mattmatt')
...
UserEmail.create!(email_address: 'manager@fake.com', user_id: fake_manager.id)
UserEmail.create!(email_address: 'manager@phaxio.com', user_id: phaxio_manager.id)
...
phaxio_user3 = UserEmail.create!(email_address: 'ceo@phaxio.com', caller_id_number: founder_num.fax_number, client_id: phaxio.id)
phaxio_user4 = UserEmail.create!(email_address: 'cto@phaxio.com', caller_id_number: founder_num.fax_number, client_id: phaxio.id)
phaxio_user1 = UserEmail.create!(email_address: 'marketing1@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user2 = UserEmail.create!(email_address: 'marketing2@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user5 = UserEmail.create!(email_address: 'developer1@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user6 = UserEmail.create!(email_address: 'developer2@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
phaxio_user7 = UserEmail.create!(email_address: 'matt@phaxio.com', caller_id_number: dev_num.fax_number, client_id: phaxio.id)
