class FaxNumber < ApplicationRecord
	...
	private
		...
		class << self
			...
			# 	fax_numbers_from_api = [{:phone_number =>"+15055550125", :city =>"Santa Fe", :state =>"California", :country =>"United States of America", :cost =>200, :last_billed_at =>"2018-07-09T11:36:25.000-05:00", :provisioned_at =>"2018-03-09T11:36:25.000-06:00", :callback_url =>nil},
			# {:phone_number =>"+15055550124", :city =>"Santa Fe", :state =>"California", :country =>"United States of America", :cost =>200, :last_billed_at =>"2018-07-09T11:36:25.000-05:00", :provisioned_at =>"2018-03-09T11:37:25.000-06:00", :callback_url =>nil},
			# {:phone_number =>"+15055550123", :city =>"Santa Fe", :state =>"California", :country =>"United States of America", :cost =>200, :last_billed_at =>"2018-07-09T11:36:25.000-05:00", :provisioned_at =>"2018-03-09T11:38:25.000-06:00", :callback_url =>nil},
			# {:phone_number =>"+15055550122", :city =>"Santa Fe", :state =>"California", :country =>"United States of America", :cost =>200, :last_billed_at =>"2018-07-09T11:36:25.000-05:00", :provisioned_at =>"2018-03-09T11:39:25.000-06:00", :callback_url =>nil}, 
			...
			# {:phone_number =>"+18885558888", :city =>"Toll Free Service", :state =>"Non-Geographic", :country =>"United States of America", :cost =>200, :last_billed_at =>"2018-07-24T14:45:04.000-05:00", :provisioned_at =>"2018-07-24T14:45:04.000-05:00", :callback_url =>nil},
